...
namespace FrbaCommerce.Comprar_Ofertar
{
    public partial class Ofertar : Form
    {
        ...
        {
            String sql = "INSERT INTO LOS_SUPER_AMIGOS.Oferta(monto, gano_subasta, fecha, usuario_id, publicacion_id, calificacion_id) VALUES (@monto, 0, @fecha, @usuario, @publicacion, NULL)";
