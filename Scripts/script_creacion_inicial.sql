...
IF (OBJECT_ID('LOS_SUPER_AMIGOS.crear_usuario', 'U') IS NOT NULL)
DROP PROCEDURE LOS_SUPER_AMIGOS.crear_usuario
GO

IF (OBJECT_ID('LOS_SUPER_AMIGOS.agregar_id_publ', 'U') IS NOT NULL)
DROP FUNCTION LOS_SUPER_AMIGOS.agregar_id_publ
GO

IF (OBJECT_ID('LOS_SUPER_AMIGOS', 'U') IS NOT NULL)
